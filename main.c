        ...
        //k compter pour Mc
            if(z<m){
             ...
             B=1;//si trover le chaine de rifrence evec le tb tomp
                        ...
                        if(B==0){//si n'est pas trover le chaine de rifernce
                        Temp[z]=T1[k];
                        z++;
                        }
                        }
...
//definir les variables
    ...
    //Lire la ms
    printf("Donnez la taille du memoire cache : ");scanf("%d",&tdmc);
    //Lire les mots
    printf("Donnez le Nombre des mots :  ");scanf("%d",&nbrmot);
    //lire declation
    ...
    read(mot,nbrmot);
    st=1;
   do{ printf("\n\n\n\n1- FIFO\n2- Aleatoire\n3- LRU\n4- Exit\nVeillez Choisi l'Algorithme a utiliser : ");scanf("%d",&choise);
    if(choise==5){
        st=0;
